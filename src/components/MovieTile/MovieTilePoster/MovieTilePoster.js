...
const MovieTilePoster = ({ movie, setListenStorageOperation, listenStorageOperation }) => {
  ...
  useEffect(() => {
    ...
    setListenStorageOperation(listenStorageOperation + 1);
